            ...
            <div class="space-y-3">
              ...
              >
                <svg
                  ...
                  stroke="currentColor"
                  stroke-width="2"
                  v-html="categoryIcons.selection"
                ></svg>
            ...
            <div class="space-y-3">
              ...
              >
                <svg
                  ...
                  stroke="currentColor"
                  stroke-width="2"
                  v-html="categoryIcons.navigation"
                ></svg>
            ...
            <div class="space-y-3">
              ...
              >
                <svg
                  ...
                  stroke="currentColor"
                  stroke-width="2"
                  v-html="categoryIcons.canvas"
                ></svg>
                {{ t('shortcuts.categories.canvas') }}
              </div>
              <div class="space-y-2">
                <div
                  v-for="shortcut in categories.canvas.filter(
