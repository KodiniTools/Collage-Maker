...
async function renderCanvas() {
  ...
  const canvasImages = collage.images.filter(img => !img.isGalleryTemplate)
  ...
  for (const img of [...canvasImages].sort((a, b) => a.zIndex - b.zIndex)) {
    ...
    // Löschbutton zeichnen (oben rechts, immer sichtbar)
