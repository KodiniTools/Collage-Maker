...
<template>
  <button
    ...
    class="p-2 rounded-lg hover:bg-muted/20 dark:hover:bg-navy/50 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 dark:focus:ring-offset-surface-dark"
