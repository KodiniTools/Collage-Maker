...
<template>
  <div class="w-full bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4" style="min-height: 600px;">
    <h2 class="text-lg font-semibold mb-4">{{ t('text.title') }}</h2>

    <div v-show="!collage.selectedText" class="text-sm text-gray-500 dark:text-gray-400 text-center py-4">
      {{ t('text.noSelection') }}
    </div>

    <div v-show="collage.selectedText" class="space-y-4">
      <!-- Text Content -->
      <div>
