    ...
    <div class="flex gap-2 mt-3">
      <button
        ...
        class="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium
               bg-accent text-slate-dark hover:bg-accent/90 disabled:opacity-50 disabled:cursor-not-allowed
      ...
      <button
        ...
        :disabled="isProcessing"
        class="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium
               border border-muted dark:border-slate text-text dark:text-text-dark
