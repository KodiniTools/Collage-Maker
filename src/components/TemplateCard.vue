...
<template>
  <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all cursor-pointer group">
    <!-- Thumbnail -->
    <div
      @click="emit('load', template)"
      class="relative aspect-video bg-gray-100 dark:bg-gray-900 overflow-hidden"
    >
      <img
    ...
    <div class="p-4">
      <div class="flex items-start justify-between gap-2">
        ...
        <button
          ...
          class="p-1.5 hover:bg-red-100 dark:hover:bg-red-900/30 rounded transition-colors flex-shrink-0"
